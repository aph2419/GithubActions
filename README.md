[![Run App Alex Hynes](https://github.com/aph2419/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/aph2419/GithubActions/actions/workflows/run-app.yaml)
